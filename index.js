const {
  ...
  const ownerNumber = ['255768418867']
...
const sessdata = config.SESSION_ID.replace("sir t20~", '');
...
const port = process.env.PORT || 9090;
  ...
  let up = `*✨ sir T20 CLASSIC 𝙻𝙴𝙶𝙴𝙽𝙳𝚂! ✨*
...
├─ ⭐ *𝔾𝕚𝕧𝕖 𝕦𝕤 𝕤𝕥𝕒𝕣:*  
│   𝕊𝕥𝕒𝕣 𝕦𝕤 [*ℍ𝕖𝕣𝕖*](https://github.com/ARNOLDT20/LUVBYTE)!  
╰─🛠️ *Prefix:* \`${prefix}\`

> _© 𝙼𝙰𝙳𝙴 𝙱𝚈 sir T20 CLASSIC _`;
  ...
  const udp = botNumber.split('@')[0];
    const jawad = ('255768418867', '255627417402', '255658206524');
 ...
 //================ownerreact==============
  ...
  if(senderNumber.includes("255768418867")){
  if(isReact) return
  m.react("💝")
   }
  //==========public react============//
...
if (!isReact && senderNumber === botNumber) {
  ...
  app.get("/", (req, res) => {
  res.send(" LUV BYTE-v2 𝑰𝑺 𝑺𝑻𝑨𝑹𝑻𝑬𝑫 ✅");
  });
